...
public class TermuxToolbarPropertyTest {
    ...
    @Test
    public void simultaneousTextInputPropertyIsKnownAndDefaultsToFalse() {
        ...
        assertTrue(TermuxPropertyConstants.TERMUX_DEFAULT_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST.contains(key));
        assertFalse((boolean) TermuxSharedProperties.getInternalTermuxPropertyValueFromValue(null, key, null));
